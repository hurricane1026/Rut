...
(#178, #179); slice 3, the `Cache` substrate, is implemented by PR #181;
slices 4–6 — i64 bitwise, time/max, and `examples/ratelimit.rut` — remain in
flight as PRs #182/#183/#184. This file records the *decisions* and their
