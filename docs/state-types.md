...
(#178, #179), and slice 5 (time/max) is implemented by PR #183. Slices 3, 4,
and 6 — the `Cache` substrate, i64 bitwise, and `examples/ratelimit.rut` —
remain in flight as PRs #181/#182/#184. This file records the *decisions*
