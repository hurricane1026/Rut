...
- Pipelined validated-failure support has three distinct tracks. Closed #276
  ...
  ordinary JIT dispatch. #277 owns request1+request2 already coalesced before
  strict-policy admission. #278 owns strict-policy admission/execution after a
...
- The post-#273 audit identified an exact-HEAD streaming, exact-bodyless-GET
  ...
  Broader pipelined behavior remains excluded; closed #276 proves only its late-
  arrival 502-to-ordinary-local slice, while #277/#278 remain open. `/api/`
