...
| one exact `location = /old { return 301 http://redirect.example/new; }` beside the accepted root proxy, for one bounded fresh explicit-close GET | yes: distinct bounded semantic action with source provenance; `6fa09648` | no: present/forged/dual action inventory rejects before output pending lowering | yes for the bounded generic fixed redirect profile; #308 closed through metadata/ownership `054d4d23`, activation `2d9ec5b3`, and loader/JIT/io_uring production `bdaecb4d` | pinned nginx oracle `da414a71` and independent ordinary-RUT production proof exist; converter golden/ownership and converter-generated differential remain absent | NOT_IMPLEMENTED |
