...
| one exact literal `location = /static` returning exact 200 beside the accepted root proxy | no; #286 | no; #286 | partial: strict nginx-shaped status-200 response is proven and #287 closed, but exact path terminator placement is missing; #288 | pinned nginx exact-location baseline plus ordinary-RUT top-level response differential; no generated-converter routing evidence | BLOCKED_BY_RUT |
