...
- Pinned nginx 1.29.7 also keeps a default-keepalive HEAD reusable after a read
  ...
  real gap. The timeout/504 path remains absent; the broader failure domain
  stays unsupported and does not upgrade
