...
- The post-#273 audit identified an exact-HEAD streaming, exact-bodyless-GET
  ...
  async ordinary-RUT unavailable-upstream production wire remains. `efefc901`
  keeps the split disabled until #267's evidence and the converter
