...
| nginx default upstream HTTP version and request headers | no | no | partial: explicit fixed HTTP/1.1 header-only policy; #252 | RUT recording-upstream test; no nginx diff | PARTIAL |
