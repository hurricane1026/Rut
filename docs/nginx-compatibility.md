...
| one exact `location = /old { return 301 http://redirect.example/new; }` beside the accepted root proxy, for one bounded fresh explicit-close GET | yes: distinct bounded semantic action with source provenance; `6fa09648` | not yet committed: lowering/golden/owned-config work is preserved locally for #307 and now resumes after #309/#310 closure | yes for the exact generic composition: fixed redirect #308, 768-slot lexer #309, metadata `77847b51`, atomic activation `ceb05091`, and independently reviewed ordinary-source real-io_uring proof `8b314151`; H2 and broader conditional forwarding remain excluded | pinned nginx oracle `da414a71` and generic RUT production/compiler evidence exist; converter golden/ownership and converter-generated differential remain uncommitted/absent | NOT_IMPLEMENTED |
