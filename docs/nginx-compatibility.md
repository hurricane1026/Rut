...
| automatic slash redirect for proxied prefix location (`/api` → `/api/`) | no | no | under investigation in #260 | pinned observation only; no converter differential | NOT_IMPLEMENTED |
