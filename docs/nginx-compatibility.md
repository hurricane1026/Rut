...
| automatic slash redirect for proxied prefix location (`/api` → `/api/`) | no | no | missing request-derived redirect primitive; #261 blocks #260 | pinned nginx GET/close full-wire baseline with query/authority and zero upstream | BLOCKED_BY_RUT |
