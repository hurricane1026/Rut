...
| one exact `location = /old { return 301 http://redirect.example/new; }` beside the accepted root proxy, for one bounded fresh explicit-close GET | yes: distinct bounded semantic action with source provenance; `6fa09648` | no: lowering attempt stopped without commit; #309 closed the 653-slot token-capacity gap, while #310 conditional complete-buffered forward admission still blocks faithful output | partial composition: fixed redirect is closed/proven by #308, generic 768-slot lexer capacity by #309, and behavior-neutral preflight timing metadata by `77847b51`; deferred conditional selection remains deliberately unadmitted/unexecutable until #310 atomic activation | pinned nginx oracle `da414a71` and independent fixed-redirect RUT production proof exist; converter golden/ownership and converter-generated differential remain absent | BLOCKED_BY_RUT |
