...
| nginx default proxied response buffering/commit | implicit | no; #271 blocks faithful broad lowering; generic lexer-capacity prerequisite #274 is closed | partial: ordinary RUT supports bounded complete-content-length buffering for selected cleartext H1.1 request/response profiles, including validated preconnect failures, sequential reuse, one late-arriving ordinary successor (#276), one pre-admission coalesced strict-to-local successor (#277 narrow phase), and one already-dispatched depth-one strict exact-GET successor (#278 closed). HEAD/CONNECT/Other/OPTIONS-star, broader bodies/framing/status/size, transforms, protocols, transports, reuse/retry, mutations, and deeper pipelines remain excluded | extensive deterministic ownership/race/retirement/D2 matrices plus ordinary-source wires. Exact sequential and #278 late-successor converter-generated pinned-nginx differentials are committed; no broad default-buffering golden or differential claim exists | BLOCKED_BY_RUT |
...
| one exact literal `location = /static` returning exact 200 beside the accepted root proxy | no; #286 | no; #286 | partial: strict nginx-shaped status-200 response is proven and #287 closed; #288 exact-terminator compiler/runtime activation plus depth-zero and bounded depth-one ordinary-source production evidence are implemented, but nginx-vs-hand-authored-RUT evidence D3 remains | pinned nginx exact-location baseline, ordinary-RUT top-level response differential, ordinary exact-route production wire, and bounded exact-successor production boundary; no exact-route cross-runtime differential or generated-converter routing evidence | BLOCKED_BY_RUT |
...
- Pipelined validated-failure support has three distinct tracks. Closed #276
  ...
  domains remain open. Closed #278 owns one exact strict-policy admission and
...
- The post-#273 audit identified an exact-HEAD streaming, exact-bodyless-GET
  ...
  exact-GET-to-ordinary-static phase, and closed #278 proves only the separate
