...
static const HelperEntry kHelpers[] = {
    ...
    {"rut_helper_resp_publish_body", reinterpret_cast<void*>(&rut_helper_resp_publish_body)},
    ...
    {"rut_helper_json_capture_reset", reinterpret_cast<void*>(&rut_helper_json_capture_reset)},
